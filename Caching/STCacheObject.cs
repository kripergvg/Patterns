...
namespace Caching
{
    public class STCacheObject<T>
    {
        ...
        public STCacheObject(string key, Func<T> callback, int threshold = 100, int duration = 60)
        {
        ...
        public DateTime Expiry { get { return DateTime.Now.AddSeconds(10); } }
        ...
        public void HandleUpdateCallback(string key, CacheItemUpdateReason reason, out object data, out CacheDependency dependency, out DateTime absExpiry, out TimeSpan slidingExpiry)
        {
